...
\label{eq:sd_aqi}
\end{equation}
where constant $C$ sets the numerical range (e.g., $C=6$ in the prototype). Example weights (heuristic) used in the IoT Hydra implementation:
\begin{align*}
...
The authors thank contributors to the IoT Hydra project and field partners for testing and feedback.
...
\author{\IEEEauthorblockN{IoT Hydra Team}\\
\IEEEauthorblockA{\textit{IoT Hydra Project}}}
